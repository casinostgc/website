...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { content: @testimonial.content, name: @testimonial.name, subject: @testimonial.subject }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { content: @testimonial.content, name: @testimonial.name, subject: @testimonial.subject }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
