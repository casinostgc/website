...
class PortsControllerTest < ActionController::TestCase
  ...
  test "should create port" do
    assert_difference('Port.count') do
      post :create, port: { description: @port.description, latitude: @port.latitude, location: @port.location, longitude: @port.longitude, name: @port.name, slug: @port.slug }
    end
  ...
  test "should update port" do
    patch :update, id: @port, port: { description: @port.description, latitude: @port.latitude, location: @port.location, longitude: @port.longitude, name: @port.name, slug: @port.slug }
    assert_redirected_to port_path(assigns(:port))
  end
