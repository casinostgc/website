class CruiseListsController < ApplicationController
	...
	def create
		...
		respond_to do |format|
			if @cruise_list.save
				format.html { redirect_to @cruise_list, notice: 'Cruise list was successfully created.' }
	...
	def update
		respond_to do |format|
			if @cruise_list.update(cruise_list_params)
				format.html { redirect_to @cruise_list, notice: 'Cruise list was successfully updated.' }
	...
	def destroy
		@cruise_list.destroy
		respond_to do |format|
			format.html { redirect_to cruise_lists_url, notice: 'Cruise list was successfully destroyed.' }
